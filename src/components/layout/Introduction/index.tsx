    ...
    <Wrapper>
      <Header>
        ...
        <Description>
          ...
          <br />
          <br />
          개발자는 본인이 짠 코드의 의도를 명확히 전달 할 수 있어야 합니다. 그러므로 전반적인 기획을
          이해하는 것은 가장 중요한 요소입니다.{' '}
          <b>
            기획의 의도를 파악하고 기존 코드를 바탕으로 명세를 정의하고 코드를 설계해 나갈 수 있는
            역량이 저의 강점
          </b>
          입니다. 구현 이전에 기획 미팅에 참여함으로써 구현이 어려운 부분이나 사용성이 더 좋은
          방향으로 이끌어 나갑니다. 기획과 비즈니스 로직의 이해를 바탕으로 프론트엔드 신입
          온보딩&#40;업무 프로세스와 코드 구조&#41;을 도맡아 하고있으며, 생산성이 더 좋은 방향이
          있다면 주저하지 않고 시도합니다.
        </Description>
      </Header>
      <Contents>
        <Content $delay={0.4}>
          ...
          <UL>
            <li>
              ...
              것은 중요한 요소입니다. 이를 고려하여{' '}
              <b>Custom Hook과 Compound Pattern의 Component</b>를 만들어 사용한 경험이 있습니다.
            </li>
            <li>
              ...
              바탕으로,{' '}
              <b>
                의존성 역전을 활용하여 Context를 관리하고, 비즈니스 로직에 따라 컴포넌트를 분리하여
                결합도를 낮춘 경험
              </b>
              이 있습니다.
            </li>
        ...
        <Content $delay={0.6}>
          ...
          <UL>
            ...
            <li>
              팀 간의 소통, 회의록, 기능/개발의 명세 문서화의 필요성을 느껴 도입하였고, 팀 내 소통을
              더 원활하게 만드는 방법에 집중합니다.
            </li>
          </UL>
        </Content>
        <Content $delay={0.8}>
          ...
          <UL>
            ...
            <Annotation>
              *있어빌리티: ‘있어 보인다’와 유틸리티&#40;utility&#41;를 결합한 단어로, 실용성과 기능
              이상의 가치를 전달하기 위해 화면에 멋과 감각적인 요소를 더하는 것을 의미합니다.
            </Annotation>
          </UL>
        </Content>
        <Content $delay={0.2}>
          ...
          <UL>
            <li>CSS의 디테일한 작업에서 스트레스를 받기보다 오히려 성취감을 느낍니다.</li>
            <li>
              대시보드와 스케줄러에서 전체 화면에 스크롤이 아닌, 콘텐츠 안에서만 스크롤이 생겨야
              한다는 요구사항이 있었습니다. 기존에는 중첩된 레이아웃이 많아 수정이 어려운 상태였고,
              팀원들이 손 대기를 꺼려했던 부분이었습니다. 이를 해결하기 위해 레이아웃을 직접 손으로
              그리면서 분석하였고, flex와 height 등 CSS 속성을 활용하여 쉽게 문제를 해결한 경험이
              있습니다.
            </li>
            <li>
