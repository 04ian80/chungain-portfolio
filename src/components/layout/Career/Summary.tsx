      ...
      <Contents>
        <Content>
          ...
          <UL>
            ...
            <ul>
              <li>
                전역 레이아웃 컴포넌트 설계 및 재사용으로 <Highlight>코드 중복 60% 감소</Highlight>
              </li>
              <li>
                스크롤 방향 기반 텍스트 fade 애니메이션을{' '}
                <Highlight>Custom Hook으로 모듈화하여 재사용성 확보</Highlight>
              </li>
            </ul>
            <li>
            ...
            <li>
              ...
              <Highlight>테스트 코드 도입 주도 및 테스트 코드 작성 가이드 정립</Highlight>
            </li>
            <li>
            ...
            <ul>
              <li>독립적인 환경에서 컴포넌트 동작 검증 및 UI 일관성 유지</li>
              <li>
                디자인과 구현 간의 불일치로 평균 3회 진행되던 QA 프로세스를{' '}
                <Highlight>67% 단축시켜, 개발 생산성 향상</Highlight>
              </li>
            </ul>
          </UL>
        </Content>
        ...
        <Content>
          ...
          <UL>
            ...
            <li>
              팀 규모 확장에 따라 코드리뷰의 효율성을 높이고자 PR Template과 Label 추가 시스템을
              구축하고, 슬랙 회고 리마인더 워크플로우를 도입하여{' '}
              <Highlight>리뷰 프로세스를 체계화</Highlight>
            </li>
            <li>
              스프린트 도입과 개발 명세서 체계화, 노션을 활용한 문서화 등 협업 프로세스 개선을
              주도적으로 제안하고 실행
            </li>
