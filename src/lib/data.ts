    ...
    content: [
      {
        ...
        subcontent: `줄곧 하나의 길만을 바라보며 걸어온 저에게는 취미가 하나 있습니다. 바로 미드와 영화 시청,
          ...
          종일 그림을 그리는 집중력을 보고 개발 공부 중이던 지인이 저에게 프론트엔드를 추천해
    ...
    content: [
      {
        ...
        그만큼 커뮤니케이션의 중요성을 자각하고 제가 생각하는 이상적인 커뮤니케이션 방법을
        실현하고 있습니다.`,
      },
      {
        subtitle: '커뮤니케이션 경험',
        ...
        해야 합니다. 저는 언어가 다른 사람과 소통을 해본 경험이 있고, 지구 반대편에 있는 문화를
        가진 사람들과 교류하면서 다양한 경험을 쌓았고, 이를 계기로 커뮤니케이션 습관을 지니게
        되었습니다.`,
      },
      {
        subcontent: `덕분에 에러를 마주하여 공식 문서를 살펴봐야 할 때, 오픈 소스에 문의하거나 기여해야 할 때
        등등 영어로 된 문서를 참고하거나 영어로 소통해야 하는 상황을 피하지 않고 적극적으로
        시도합니다. 최근 Next.js로 만든 사이드 프로젝트에서 발생한 next/font 관련 이슈를
      ...
      },
      {
        ...
        투명한 커뮤니케이션을 지향하며, 팀원이 제공하는 의견을 경청하며 피드백을 적극적으로
        반영합니다. 앞서 언급한 핵심을 지키며 코드 리뷰를 적극적으로 진행한 팀으로 선정되었습니다.
        이러한 경험을 토대로 좋은 코드 리뷰를 위한 방향성을 가지는 계기가 되었습니다.`,
      },
    ],
  },
  {
    ...
    content: [
      {
        subcontent: `상위 10%가 되기 위한 태도는 어느 환경에서나 중요합니다. 저는 어떠한 환경에서라도 10%가 되기 위한 태도를 갖춥니다. 개발자로서 10%의 태도를 갖추기 위한 규칙들은 단순합니다. 제가 제일 최근에 참여했던 원티드 프리온보딩 교육기관에서의 예를 들어보자면 이러한 것들이 있습니다.`,
      },
      {
      ...
      {
        subcontent: `이러한 규칙들을 지킨 결과, 프론트엔드 개발자 교육기관에서 지원자 300명 중 최종 우수 교육생 10인에 선정되었습니다.`,
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        subcontent: `팀 프로젝트를 하면서 제가 접해보지 못한 다른 운영체제에 관한 에러를 팀원이 물어봤을 때, 직접 구글링하여 해결책을 제안해 준 경험이 있습니다. 또한, 팀원이 Git 관리에 익숙하지 않아 시각적으로 보여주면서 직접 설명한 경험이 있습니다. 이러한 경험을 통해 저 자신도 이미 알고 있는 선에서 지식을 더 확장할 수 있다는 것을 깨달았습니다.`,
      },
      {
        subtitle: '저의 지식을 공유하는 것을 좋아합니다.',
